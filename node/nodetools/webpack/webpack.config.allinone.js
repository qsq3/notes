...
sassLoader = extractCSS.extract('style-loader', [cssLoaderSet, 'postcss', 'less'], extractCSSOptions);
plugins.push(extractCSS);

plugins = plugins.concat(html_plugins(srcDir));

//config
var config = {

  entry: Object.assign(
    entries(srcDir),{'vendor': vendor }
  ),
